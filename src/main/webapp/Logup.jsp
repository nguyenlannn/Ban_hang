...
<body>
	<div id="screen">
		...
		<form action="logup" onsubmit="return check()" method="post">
			<div class="row">
				<div class="col-1"></div>
				<div class="col-10 top10" style="background-color: red; color: white;">
					${loi }
				</div>
				<div class="col-1"></div>
				...
				<div class="col-10">
					<input class="form-control" type="text" name="taiKhoan"
						id="tenTaiKhoan" required="required" pattern="^[a-zA-Z]+$">
					<small>Chỉ bao gồm a-z A-Z</small>
				</div>
				<div class="col-1"></div>
				...
				<div class="col-1"></div>
				<div class="col-10">
					<input class="form-control" type="password" name="xacThuc"
						required="required" id="xacThuc"> <span
		...
		<div class="text-center top10">
			<small>Đã có tài khoản?<a href="login"> Đăng phập</a></small>
		</div>
